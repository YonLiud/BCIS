...
export default function Lookup() {
    ...
    function handleSubmit(event) {
        ...
        axios.post('/api/report/lookup/tags', {
            ...
            <div className={styles.form}>
                <form onSubmit={handleSubmit}>
                    <div className={styles.input_field}>
                        <label htmlFor="key">
                            Key:
                            <input type="text" id="key" placeholder='Private Key / Supervisor Key' />
                        </label>
                    </div>
                    <div className={styles.input_field}>
                        <label htmlFor="tags">
                            Tags:
                            <input type="text" id="tags" placeholder='Robbery,Bank,Shootout' />
                        </label>
                    </div>
                    <div className={styles.input_field}>
